      ...
      <Content>
        <HomeBanner>
          <Category>
            {readCategoriesData(readCategoryRequest).map((item, index) => {
              return (
                <StyledLink
                  to={`/listing-page?categoryId=${index + 1}`}
                  key={index}
                >
                  ...
                  {item.name == "Arts" && <IoColorPaletteOutline />}{" "}
                  <span>{item.name}</span>
                </StyledLink>
              );
            })}
                ...
                page.data.map((product, productIndex) => {
                  ...
                  return (
                    <Item key={productIndex}>
                      ...
                      <Name>
                        <StyledNameLink
                          to={`/productdetail?id=${product.product.id}`}
                        >
        ...
        <Policy>
          <div>
            ...
            <p>
              A wide range of products at the best prices from reputable brands
            </p>
          </div>
          <div>
            <PolicyImage>
          ...
          <div>
            ...
            <p>
              Attractive after-sales policy, always ensuring customer rights
            </p>
          </div>
          <div>
            <PolicyImage>
