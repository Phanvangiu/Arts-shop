...
export default function AccountManageExchange() {
  ...
  const getUserRefundExchangeRequest = GetUserRefundExchangeRequest(
    currentPage,
    20,
    active
  );
              ...
              <OrderDetail key={index}>
                <div>
                  <StyledLinkNoDecoration
                    to={`/account/order-detail?id=${item.id}`}
                  >
                    #
                  ...
                  {item.refund && item.refund.status == "Pending" && (
                    <p>Pending Refund</p>
                  )}
                  ...
                  {item.exchange && item.exchange.status == "Pending" && (
                ...
                <ProductDetail>
                  ...
                  <div>
                    <StyledLinkNoDecoration
                      to={`/productdetail?id=${item.variant.product.id}`}
                    >
                ...
                <Buttons>
                  ...
                  {item.refund && (
                    <button
                      onClick={() =>
                        navigate(
                          `/account/account-refund-detail?id=${item.refund.id}`
                        )
                      }
                    >
                      View Detail
                  ...
                  {item.exchange && (
                    <button
                      onClick={() =>
                        navigate(
                          `/account/account-exchange-detail?id=${item.exchange.id}`
                        )
                      }
                    >
                      View Detail
                  ...
                  {item.newOrderExchange && (
                    <button
                      onClick={() =>
                        navigate(
                          `/account/account-exchange-detail?id=${item.newOrderExchange.id}`
                        )
                      }
                    >
                      View Detail
